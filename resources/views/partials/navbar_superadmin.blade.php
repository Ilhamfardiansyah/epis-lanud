        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    ...
                    <a class="nav-link {{ Request::is('dashboard/datamaster') ? 'active' : '' }}"
                        href="{{ route('datamaster') }}" role="button" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fa fa-cubes"></span></span><span class="nav-link-text ps-1">
                                Data Master</span>
                        </div>
                    </a>
        </div>
