    ...
    <section class="sheet padding-10mm">
        ...
        <table style="margin: 25px">
            ...
            <tr>
                ...
                <td style="vertical-align: top">:</td>
                <td style="width: 35em; vertical-align: top;">{{ $dataPegawai->siyalem->urusan_polisi_militer }}</td>
            </tr>
            <tr>
                <td style="width: 1em; vertical-align: top;">12.</td>
                <td style="width: 20em; vertical-align: top;">Keterangan Foto</td>
                <td style="width: 1em; vertical-align: top">:</td>
                <td style="width: 35em; vertical-align: top;">{{ $dataPegawai->siyalem->data_fotos->ket_pic }}</td>
            </tr>
        </table>
