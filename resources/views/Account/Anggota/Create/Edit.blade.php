                                ...
                                <div class="card-header d-flex flex-between-center pb-0">
                                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                                        <img src="{{ asset($dataPegawai->siyalem->data_fotos->kanan_pic) }}"
                                            ...
                                            style="display: inline; float: left; margin-right: 50px; width: 350px; height: 350px"
                                            alt="{{ asset('assets/img/user.png') }}">
                                        <input type="file" name="kanan_pic" id="kanan_pic" class="form-control"
                                            style="width: 350px">
                                    </div>
                                </div>
                                <div class="card-body pt-2">
                                ...
                                <div class="card-header d-flex flex-between-center pb-0">
                                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                                        <img src="{{ asset($dataPegawai->siyalem->data_fotos->kiri_pic) }}"
                                            ...
                                            style="display: inline; float: left; margin-right: 50px; width: 350px; height: 350px"
                                            alt="{{ asset('assets/img/user.png') }}">
                                        <input type="file" name="kiri_pic" id="kiri_pic" class="form-control"
                                            style="width: 350px">
                                    </div>
                                </div>
                                <div class="card-body pt-2">
                                ...
                                <div class="card-header d-flex flex-between-center pb-0">
                                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                                        <img src="{{ asset($dataPegawai->siyalem->data_fotos->sidik_pic) }}"
                                            ...
                                            style="display: inline; float: left; margin-right: 50px; width: 350px; height: 350px"
                                            alt="{{ asset('assets/img/user.png') }}">
                                        <input type="file" name="sidik_pic" id="sidik_pic" class="form-control"
                                            style="width: 350px">
                                    </div>
                                </div>
                                <div class="card-body pt-2">
                                        ...
                                        <div class="card-body bg-light">
                                            ...
                                            <div class="row gx-2">
                                                <div class="col-12 mb-3">
                                                    <label class="form-label" for="nopassring">No Passring</label>
                                                    <input class="form-control" id="event-name" name="nopassring"
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <input class="form-control datetimepicker" id="NRP"
                                                        name="NRP" type="text" value="{{ $dataPegawai->NRP }}" />
                                                </div>
                                                <div class="col-sm-6 mb-3">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <input class="form-control datetimepicker" id="tgl"
                                                        name="tgl" type="text" value="{{ $dataPegawai->tgl }}" />
                                                </div>
                                                <div class="col-sm-6 mb-3">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="agama"
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="warnakulit">Warna Kulit</label>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="alamatsekarang">Alamat
                                                        Sekarang</label>
                                                    <input class="form-control datetimepicker" id="alamatsekarang"
                                                        name="alamatsekarang" type="text"
                                                        value="{{ $dataPegawai->alamatsekarang }}" />
                                                </div>

                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="ayahalamat">Ayah dan Alamat</label>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="ibualamat">Ibu dan Alamat</label>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="istrialamat">Istri dan
                                                        Alamat</label>
                                                    <input class="form-control datetimepicker" id="istrialamat"
                                                        name="istrialamat" type="text"
                                                        value="{{ $dataPegawai->istrialamat }}" />
                                                </div>

                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="tempatnikah">Tempat & Akte
                                                        Nikah</label>
                                                    <input class="form-control datetimepicker" id="tempatnikah"
                                                        name="tempatnikah" type="text"
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="ortuistrialamat">Ortu Istri dan
                                                        Alamat</label>
                                                    <input class="form-control datetimepicker" id="ortuistrialamat"
                                                        name="ortuistrialamat" type="text"
                                                        value="{{ $dataPegawai->ortuistrialamat }}" />
                                                </div>

                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="tempatnikah">Istri Alamat</label>
                                                    <input class="form-control datetimepicker" id="tempatnikah"
                                                        name="tempatnikah" type="text"
                                                        value="{{ $dataPegawai->tempatnikah }}" />
                                                </div>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="jenis">Jenis Kelamin</label>
                                                    <select class="form-select" id="basic-form-gender" name="jenis"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-12">
                                                    <div class="border-dashed-bottom my-3"><b>SIYALEMENS</b></div>
                                                </div>

                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="lembaga">Lembaga (Adegan)</label>
                                                    <select class="form-select" id="basic-form-gender" name="lembaga"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="sikap"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender"
                                                        name="bangun_kepala" aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="rambut">Rambut</label>
                                                    <select class="form-select" id="basic-form-gender" name="rambut"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="kening"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="dahi"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="hidung"
                                                        aria-label="Default select example">
                                                        ...
                                                        <option
                                                            ...
                                                            Batangnya:Membentuk kedalam/keluar lurus, alasnya menuju ke
                                                            atas
                                                        </option>
                                                        <option value="Lain-Lain">Lain-Lain</option>
                                                    </select>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="bibir"
                                                        aria-label="Default select example">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender" name="telinga"
                                                        aria-label="Default select example">
                                                        ...
                                                        <option
                                                            ...
                                                            Berlengket dengan kepala dnegan kepala bagian atas mengenai
                                                            kepala belakang
                                                        </option>
                                                        <option value="Lain-Lain">Lain-Lain</option>
                                                    </select>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="basic-form-gender"
                                                        name="urusan_polisi_militer" aria-label="Default select example">
                                                        <option selected disabled>--Pilih Urusan Polisi Militer--
                                                        </option>
                                                        <option value="Pernah"
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <label class="form-label" for="ket_pic">ket_pic</label>
                                                    <input class="form-control datetimepicker" id="ket_pic"
                                                        name="ket_pic" type="text"
