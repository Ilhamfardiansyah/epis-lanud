            ...
            <div class="col-12">
                <div class="card h-100">
                    ...
                    <div class="card-body bg-light">
                        ...
                        {{-- Form Foto --}}
                        <form action="{{ route('update.foto', $dataPegawai->id) }}"
                              method="POST"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card h-md-100">
                                        ...
                                        <div class="card-body pt-2">
                                            <div>
                                                <img
                                                    style="width: 100%; height: 400px; object-position: center; object-fit: cover"
                        ...
                        {{-- Form --}}
                        <form action="/dashboard/update/data/{{ $dataPegawai->id }}"
                              method="post">
                            @csrf
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                ...
                                                <input class="form-control datetimepicker"
                                                       id="pangkat" name="pangkat" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label"
                                                       for="kesatuan">Kesatuan</label>
                                                <input class="form-control datetimepicker"
                                                       id="kesatuan" name="kesatuan" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                ...
                                                <input class="form-control datetimepicker"
                                                       id="tandajasa" name="tandajasa" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                ...
                                                <input class="form-control datetimepicker"
                                                       id="tinggi" name="tinggi" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label" for="warnakulit">Warna
                                                    Kulit</label>
                                                <input class="form-control datetimepicker"
                                                       id="warnakulit" name="warnakulit" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                ...
                                                <input class="form-control datetimepicker"
                                                       id="mata" name="mata" type="text"
                                                       value="{{ $dataPegawai->mata }}"/>
                                            </div>

                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label"
                                                       for="rambut">Rambut</label>
                                                <input class="form-control datetimepicker"
                                                       id="rambut" name="rambut" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label"
                                                       for="goldarah">goldarah</label>
                                                <input class="form-control datetimepicker"
                                                       id="goldarah" name="goldarah" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label" for="ayahalamat">Ayah dan
                                                    Alamat</label>
                                                <input class="form-control datetimepicker"
                                                       id="ayahalamat" name="ayahalamat" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label" for="ibualamat">Ibu dan
                                                    Alamat</label>
                                                <input class="form-control datetimepicker"
                                                       id="ibualamat" name="ibualamat" type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label" for="istrialamat">Istri
                                                    ...
                                                    Alamat</label>
                                                <input class="form-control datetimepicker"
                                                       id="istrialamat" name="istrialamat"
                                                       type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label" for="tempatnikah">Tempat &
                                                    ...
                                                    Nikah</label>
                                                <input class="form-control datetimepicker"
                                                       id="tempatnikah" name="tempatnikah"
                                                       type="text"
                                            ...
                                            <div class="col-12 sm-6 mb-3">
                                                <label class="form-label" for="namaanak">Nama
                                                    Anak</label>
                                                <input class="form-control datetimepicker"
                                                       id="namaanak" name="namaanak" type="text"
